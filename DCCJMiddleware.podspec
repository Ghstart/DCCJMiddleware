...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.dependency 'DCCJCashier', '~> 0.3.3'
  s.dependency 'DCCJUser', '~> 0.1.3'
  s.dependency 'DCCJMessageCenter', '~> 0.1.7'
  s.dependency 'DCCJNetwork', '~> 0.3.3'
  s.dependency 'DCCJLogin', '~> 0.1.5'
end
